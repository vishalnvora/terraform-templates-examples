...
# //  Indicates dedicated Data nodes in the cluster //
...
# // Indicates dedicated master nodes in the cluster //
...
# // Indicates Coordinated only node configutation in the cluster //

variable "cluster_config_coordinating_only_enabled" {
  description = "Indicates whether dedicated cpordinated nodes are enabled for the cluster"
  type        = bool
  default     = true
}

variable "cluster_config_coordinating_only_type" {
  description = "Instance type of the dedicated master nodes in the cluster"
  type        = string
  default     = "t2.micro.elasticsearch"
}
